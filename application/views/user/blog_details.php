...
$date = date( 'W F, Y', strtotime($blog_details['created_at']) );
$pre_img = APP_URL.IMG_TESTIMONIAL.$blog_details['img_src'];
$descr = $blog_details['descr'];
?>
<!-- Page Content -->
    <!-- Banner Starts Here -->
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="main-button">
                    <!-- <a rel="nofollow" href="javascript:;" target="_parent">Download Now!</a> -->
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="javascript:;"><h4><?php echo $title; ?></h4></a>
                      <ul class="post-info">
