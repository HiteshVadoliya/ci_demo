                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value='<?php if(isset($edit) && $edit['title']!='' ) { echo $edit['title']; } else { set_value('title'); } ?>' id="title" name="title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value='<?php if(isset($edit) && $edit['link_url']!='' ) { echo $edit['link_url']; } else { set_value('link_url'); } ?>' id="link_url" name="link_url">
                                    </div>

                                    <div class="form-group">
                                        <label for="title">is_login</label>
                                        <select class="form-control required" name="is_login" id="is_login">
                                            <option value="1" <?php if(isset($edit) && !empty($edit) && $edit['is_login'] == 1) { echo 'selected'; } ?>>Yes</option>
                                            <option value="0" <?php if(isset($edit) && !empty($edit) && $edit['is_login'] == 0) { echo 'selected'; } ?>>No</option>
                                        </select>
                                    </div>

                                    <div class="form-group">
                                        <label for="title">is_hot_game</label>
                                        <select class="form-control required" name="is_hot_game" id="is_hot_game">
                                            <option value="1" <?php if(isset($edit) && !empty($edit) && $edit['is_hot_game'] == 1) { echo 'selected'; } ?>>Yes</option>
                                            <option value="0" <?php if(isset($edit) && !empty($edit) && $edit['is_hot_game'] == 0) { echo 'selected'; } ?>>No</option>
                                        </select>
                                    </div>

                                    <div class="form-group">
                                        <label for="title">is_new</label>
                                        <select class="form-control required" name="is_new" id="is_new">
                                            <option value="1" <?php if(isset($edit) && !empty($edit) && $edit['is_new'] == 1) { echo 'selected'; } ?>>Yes</option>
                                            <option value="0" <?php if(isset($edit) && !empty($edit) && $edit['is_new'] == 0) { echo 'selected'; } ?>>No</option>
                                        </select>
                                    </div>
